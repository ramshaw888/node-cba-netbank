...
const csvTransaction = t => `${moment(t.timestamp).format(moment.formats.default)}` + `,"${csvAmount(t.amount)}"` + `,"${t.description}"` + `,"${csvAmount(t.balance)}"\r\n`;
